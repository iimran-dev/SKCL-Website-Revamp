...
export function Developments() {
  ...
  return (
    ...
    >
      {/* Header */}
      <Container className="lg:absolute lg:left-1/2 lg:top-28 lg:z-20 lg:-translate-x-1/2 lg:px-16">
        <div className="py-20 lg:py-0">
          <Reveal>
            <SectionLabel>Signature Developments</SectionLabel>
          </Reveal>
          <Reveal delay={0.1}>
            <h2 className="mt-6 max-w-lg skcl-editorial text-4xl text-soft-white md:text-5xl lg:text-6xl">
              A portfolio of Grade A office environments.
            </h2>
          </Reveal>
          <Reveal delay={0.2}>
            <p className="mt-6 max-w-md text-sm leading-relaxed text-soft-white/60 lg:hidden">
              Scroll to explore nine developments across Chennai&apos;s principal
      ...
      <div className="absolute right-6 top-28 z-20 hidden items-center gap-3 md:right-10 md:flex lg:right-16">
      ...
      <div
        ref={trackRef}
        className="flex flex-col gap-8 px-6 pb-20 md:px-10 lg:absolute lg:bottom-0 lg:left-0 lg:flex-row lg:items-end lg:gap-6 lg:px-16 lg:pb-20"
      >
        ...
        {/* Trailing CTA panel */}
        <div className="flex min-h-[320px] flex-col items-start justify-center border border-white/10 p-8 lg:h-[68vh] lg:min-h-[440px] lg:w-[32vw] lg:border-0 lg:px-0">
          <SectionLabel>Portfolio Overview</SectionLabel>
          <p className="mt-6 skcl-editorial text-2xl text-soft-white md:text-3xl lg:pr-4">
            Nine developments. Over one million square feet delivered.
          </p>
          <p className="mt-4 max-w-sm text-sm leading-relaxed text-soft-white/60">
...
function DevelopmentCard({
  ...
  return (
    <article className="group relative h-[60vh] min-h-[420px] w-full shrink-0 overflow-hidden bg-charcoal lg:h-[68vh] lg:w-[42vw]">
      <Image
        src={dev.image}
        alt={dev.name}
        fill
